// 反退化 probe（拆桥）：决策层（decide-*.js + 组合根 rules/index.js）的目标选择与血量读取
...
/** scope：决策层 = decide-*.js（非 test）+ 组合根 rules/index.js。视图源头不在 scope。 */
function isDecideFile(rel) {
  if (rel === "battle/rules/index.js") return true;
