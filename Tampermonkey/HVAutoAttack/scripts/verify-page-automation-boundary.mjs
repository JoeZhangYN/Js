...
function checkEntry() {
  ...
  if (
    !/\[PageKind\.RIDDLE\]: runRiddlePageAutomation[\s\S]*\[PageKind\.BATTLE\]: runBattlePageAutomation[\s\S]*\[PageKind\.LOBBY\]: runLobbyPageAutomation[\s\S]*\[PageKind\.ISEKAI_LOBBY\]: runLobbyPageAutomation/.test(
      text
    )
  ) {
