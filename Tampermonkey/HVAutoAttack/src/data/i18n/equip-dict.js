// file-size-gate: exempt 第三方装备汉化词典数据
// 自 src/i18n/equip-translate.js 抽出的 4 个原始词典对象字面量(逐字保留,数据/逻辑分离)。
// loadItems/loadEquipsInfo/loadEquips/loadExtra 的 var items/equipsInfo/equips/dict 对象。
...
export const EQUIP_ITEMS = {
  ...
  "Restores 10 points of Stamina, up to the maximum of 99. When used in battle, also boosts Overcharge and Spirit by 10% for ten turns.":
    "可在战斗中使用,请在战斗道具栏设置,恢复10点精力，但不超过99。战斗时使用时,每回合增加10%的灵力和Overcharge.",
  //魔药解释
  ...
  "Various bits and pieces of scrap wood. These can be used to mend the condition of an equipment piece.":
    "各种零碎的木材，用于修复装备",
  "Some materials scavenged from fallen adventurers by a monster. Required to reforge and upgrade cloth armor.":
    "一些从怪物身上收集到的材料，用于升级布甲",
  "Some materials scavenged from fallen adventurers by a monster. Required to reforge and upgrade staffs and shields.":
    "一些从怪物身上收集到的材料，用于升级法杖和盾牌",
  "Some materials scavenged from fallen adventurers by a monster. Required to reforge and upgrade heavy armor and weapons":
    "一些从怪物身上收集到的材料，用于升级重甲和武器",
  "Some materials scavenged from fallen adventurers by a monster. Required to reforge and upgrade light armor":
    "一些从怪物身上收集到的材料，用于升级轻甲",
  ...
  "Some materials scavenged from fallen adventurers by a monster. Required to upgrade equipment bonuses to":
    "从怪物身上收集的材料，用于升级装备的",
  ...
  "It doesn&amp;#039;t weigh anything and has the consistency of air":
    "它很像空气一样轻，几乎没有重量",
  ...
  "Some materials scavenged from fallen adventurers by a monster":
    "从被击败的冒险者身上收集来的材料",
...
export const EQUIP_EXTRA = {
  ...
  //论坛里的彩虹无双品质名
  "P(<[^<]+>)+e(<[^<]+>)+e(<[^<]+>)+r(<[^<]+>)+l(<[^<]+>)+e(<[^<]+>)+s(<[^<]+>)+s":
    '<span style="background:#ffd760" >☯无双☯</span>',
