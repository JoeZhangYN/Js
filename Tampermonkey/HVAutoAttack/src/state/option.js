...
const EVENT_READ_BATTLE_ACTION_OPTIONS = "readBattleActionOptions";
...
export const OptionEvent = Object.freeze({
  ...
  READ_BATTLE_ACTION_OPTIONS: EVENT_READ_BATTLE_ACTION_OPTIONS,
...
function readBattleActionOptions() {
  return readOption() || {};
}
