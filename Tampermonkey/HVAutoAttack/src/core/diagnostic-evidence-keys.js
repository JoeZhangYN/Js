export const DiagnosticEvidenceKey = Object.freeze({
  ...
  OPTION_FAILURE: "HVAA:lastOptionFailure", SETTINGS_HVUT_CONFIG_FAILURE: "HVAA:lastSettingsHvutConfigFailure",
  ...
  I18N_INIT_FAILURE: "HVAA:lastI18nInitFailure", I18N_RESTORE_FAILURE: "HVAA:lastI18nRestoreFailure", HVUT_I18N_BRIDGE_FAILURE: "HVAA:lastHvutI18nBridgeFailure",
  ...
  HVUT_RUNTIME_FAILURE: "HVAA:lastHvutRuntimeFailure", HVUT_NAVIGATION_BRIDGE_FAILURE: "HVAA:lastHvutNavigationBridgeFailure", HVUT_HVAA_CONFIG_BRIDGE_FAILURE: "HVAA:lastHvutHvaaConfigBridgeFailure",
  HVUT_CONFIG_STORAGE_FAILURE: "HVAA:lastHvutConfigStorageFailure",
  HVUT_CONFIG_PARSE_FAILURE: "HVAA:lastHvutConfigParseFailure",
  HVUT_ITEM_SHOP_PARSE_FAILURE: "HVAA:lastHvutItemShopParseFailure", HVUT_REPAIR_LOAD_FAILURE: "HVAA:lastHvutRepairLoadFailure",
  HVUT_TOP_LEVEL_PARSE_FAILURE: "HVAA:lastHvutTopLevelParseFailure", HVUT_ABILITY_PARSE_FAILURE: "HVAA:lastHvutAbilityParseFailure", HVUT_ABILITY_UNLOCK_FAILURE: "HVAA:lastHvutAbilityUnlockFailure",
  HVUT_TRAINING_NOTIFICATION_FAILURE: "HVAA:lastHvutTrainingNotificationFailure",
  HVUT_MOOGLEMAIL_PARSE_FAILURE: "HVAA:lastHvutMoogleMailParseFailure", HVUT_MOOGLEMAIL_SEND_FAILURE: "HVAA:lastHvutMoogleMailSendFailure", HVUT_MOOGLEMAIL_ACTION_FAILURE: "HVAA:lastHvutMoogleMailActionFailure",
  HVUT_MONSTER_LAB_PARSE_FAILURE: "HVAA:lastHvutMonsterLabParseFailure", HVUT_MONSTER_LAB_UPGRADE_FAILURE: "HVAA:lastHvutMonsterLabUpgradeFailure",
  ...
  HVUT_CHARACTER_PARSE_FAILURE: "HVAA:lastHvutCharacterParseFailure", HVUT_ARMORY_PAGE_FAILURE: "HVAA:lastHvutArmoryPageFailure", HVUT_ARMORY_SUBMIT_FAILURE: "HVAA:lastHvutArmorySubmitFailure", HVUT_ARMORY_INTEGRATE_FAILURE: "HVAA:lastHvutArmoryIntegrateFailure", ALARM_NOTIFICATION_FAILURE: "HVAA:lastAlarmNotificationFailure",
...
export const DIAGNOSTIC_EVIDENCE_SOURCES = Object.freeze([
  ...
  source("optionFailure", DiagnosticEvidenceKey.OPTION_FAILURE), source("settingsHvutConfigFailure", DiagnosticEvidenceKey.SETTINGS_HVUT_CONFIG_FAILURE),
  ...
  source("i18nInitFailure", DiagnosticEvidenceKey.I18N_INIT_FAILURE), source("i18nRestoreFailure", DiagnosticEvidenceKey.I18N_RESTORE_FAILURE), source("hvutI18nBridgeFailure", DiagnosticEvidenceKey.HVUT_I18N_BRIDGE_FAILURE),
  ...
  source("hvutRuntimeFailure", DiagnosticEvidenceKey.HVUT_RUNTIME_FAILURE), source("hvutNavigationBridgeFailure", DiagnosticEvidenceKey.HVUT_NAVIGATION_BRIDGE_FAILURE), source("hvutHvaaConfigBridgeFailure", DiagnosticEvidenceKey.HVUT_HVAA_CONFIG_BRIDGE_FAILURE),
  ...
  source("hvutItemShopParseFailure", DiagnosticEvidenceKey.HVUT_ITEM_SHOP_PARSE_FAILURE), source("hvutRepairLoadFailure", DiagnosticEvidenceKey.HVUT_REPAIR_LOAD_FAILURE),
  source("hvutTopLevelParseFailure", DiagnosticEvidenceKey.HVUT_TOP_LEVEL_PARSE_FAILURE), source("hvutAbilityParseFailure", DiagnosticEvidenceKey.HVUT_ABILITY_PARSE_FAILURE), source("hvutAbilityUnlockFailure", DiagnosticEvidenceKey.HVUT_ABILITY_UNLOCK_FAILURE),
  source("hvutTrainingNotificationFailure", DiagnosticEvidenceKey.HVUT_TRAINING_NOTIFICATION_FAILURE),
  source("hvutMoogleMailParseFailure", DiagnosticEvidenceKey.HVUT_MOOGLEMAIL_PARSE_FAILURE), source("hvutMoogleMailSendFailure", DiagnosticEvidenceKey.HVUT_MOOGLEMAIL_SEND_FAILURE), source("hvutMoogleMailActionFailure", DiagnosticEvidenceKey.HVUT_MOOGLEMAIL_ACTION_FAILURE),
  source("hvutMonsterLabParseFailure", DiagnosticEvidenceKey.HVUT_MONSTER_LAB_PARSE_FAILURE), source("hvutMonsterLabUpgradeFailure", DiagnosticEvidenceKey.HVUT_MONSTER_LAB_UPGRADE_FAILURE),
  ...
  source("hvutCharacterParseFailure", DiagnosticEvidenceKey.HVUT_CHARACTER_PARSE_FAILURE), source("hvutArmoryPageFailure", DiagnosticEvidenceKey.HVUT_ARMORY_PAGE_FAILURE), source("hvutArmorySubmitFailure", DiagnosticEvidenceKey.HVUT_ARMORY_SUBMIT_FAILURE), source("hvutArmoryIntegrateFailure", DiagnosticEvidenceKey.HVUT_ARMORY_INTEGRATE_FAILURE), source("alarmNotificationFailure", DiagnosticEvidenceKey.ALARM_NOTIFICATION_FAILURE),
