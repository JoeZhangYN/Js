export const DiagnosticEvidenceKey = Object.freeze({
  ...
  BATTLE_SESSION_FAILURE: "HVAA:lastBattleRoundFailure",
  ...
  LEARNED_MONSTER_STORE_FAILURE: "HVAA:lastLearnedMonsterStoreFailure",
  ...
  ENCOUNTER_GENERATION_INCIDENT: "HVAA:lastEncounterGenerationIncident",
  ...
  UTILITY_WEIGHT_LEARNING_FAILURE: "HVAA:lastUtilityWeightLearningFailure",
  UTILITY_WEIGHT_LEARNING_DECISION: "HVAA:lastUtilityWeightLearningDecision",
  ...
  SETTINGS_HVUT_CONFIG_FAILURE: "HVAA:lastSettingsHvutConfigFailure",
  ...
  HVUT_DERIVED_STORE_FAILURE: "HVAA:lastHvutDerivedStoreFailure",
  STORAGE_MAINTENANCE_FAILURE: "HVAA:lastStorageMaintenanceFailure",
  ...
  HVUT_TOP_LEVEL_PARSE_FAILURE: "HVAA:lastHvutTopLevelParseFailure",
...
export const DIAGNOSTIC_EVIDENCE_SOURCES = Object.freeze([
  ...
  source("battleSessionFailure", DiagnosticEvidenceKey.BATTLE_SESSION_FAILURE),
  ...
  source("learnedMonsterStoreFailure", DiagnosticEvidenceKey.LEARNED_MONSTER_STORE_FAILURE),
  ...
  source("encounterGenerationIncident", DiagnosticEvidenceKey.ENCOUNTER_GENERATION_INCIDENT),
  ...
  source("utilityWeightLearningFailure", DiagnosticEvidenceKey.UTILITY_WEIGHT_LEARNING_FAILURE),
  source("utilityWeightLearningDecision", DiagnosticEvidenceKey.UTILITY_WEIGHT_LEARNING_DECISION),
  ...
  source("settingsHvutConfigFailure", DiagnosticEvidenceKey.SETTINGS_HVUT_CONFIG_FAILURE),
  ...
  source("hvutDerivedStoreFailure", DiagnosticEvidenceKey.HVUT_DERIVED_STORE_FAILURE),
  source("storageMaintenanceFailure", DiagnosticEvidenceKey.STORAGE_MAINTENANCE_FAILURE),
  ...
  source("hvutTopLevelParseFailure", DiagnosticEvidenceKey.HVUT_TOP_LEVEL_PARSE_FAILURE),
  ...
  source(
    ...
    DiagnosticEvidenceKey.HVUT_TRAINING_NOTIFICATION_FAILURE
  ),
