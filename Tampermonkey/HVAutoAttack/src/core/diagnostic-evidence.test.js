...
describe("readRecentDiagnosticEvidence", () => {
  it("returns lifecycle, decision, and effect evidence together", () => {
    ...
    expect(readRecentDiagnosticEvidence(window.sessionStorage)).toMatchObject({
      ...
      hvutNavigationBridgeFailure: { capability: "hvutNavigationBridge", stage: "reloadBlocked" }, hvutConfigStorageFailure: { capability: "hvutConfigStorage", stage: "set" }, hvutTopLevelParseFailure: { capability: "hvutTopLevelParse", stage: "topLevelDetails" }, hvutAbilityParseFailure: { capability: "hvutAbilityParse", stage: "abilityButtonType" }, hvutTrainingNotificationFailure: { capability: "hvutTrainingNotification", stage: "bottomTrainingHtmlEndTime" }, hvutMoogleMailParseFailure: { capability: "hvutMoogleMailParse", stage: "viewCurrentCod" }, hvutMonsterLabParseFailure: { capability: "hvutMonsterLabParse", stage: "upgradeChaosTokenCost" }, hvutPlayerStateParseFailure: { capability: "hvutPlayerStateParse", stage: "mainPlayerState" }, hvutShrineCapacityFailure: { capability: "hvutShrineCapacity", stage: "shrineInventoryCapacity" }, hvutShrineRewardParseFailure: { capability: "hvutShrineRewardParse", stage: "rewardSelectButton" }, hvutShrineItemParseFailure: { capability: "hvutShrineItemParse", stage: "offerItemRow" }, hvutPriceMarketParseFailure: { capability: "hvutPriceMarketParse", stage: "marketItemId" }, hvutCharacterParseFailure: { capability: "hvutCharacterParse", stage: "personaEquipSetState" },
