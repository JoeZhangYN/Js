...
describe("readRecentDiagnosticEvidence", () => {
  it("returns lifecycle, decision, and effect evidence together", () => {
    const evidenceByKey = {
      ...
      "HVAA:lastBattleRoundFailure": { capability: "battleSession", stage: "write-checkpoint" },
      ...
      "HVAA:lastBattleActionUsageCaptureFailure": {
        capability: "battleActionUsageCapture",
        stage: "action-end-log",
      },
      ...
      "HVAA:lastRiddleSubmitFailure": { capability: "riddleSubmit", stage: "click-submit" },
      "HVAA:lastRiddleImageFailure": { capability: "riddleImage", stage: "prepare-ml-payload" },
      ...
      "HVAA:lastSettingsHvutConfigFailure": {
      ...
      "HVAA:lastHvutRepairLoadFailure": {
        capability: "hvutRepairLoad",
        stage: "battlePanelRepairLoadResponse",
      },
      "HVAA:lastHvutTopLevelParseFailure": {
        capability: "hvutTopLevelParse",
        stage: "topLevelDetails",
      },
      "HVAA:lastHvutAbilityParseFailure": {
        capability: "hvutAbilityParse",
        stage: "abilityButtonType",
      },
      "HVAA:lastHvutAbilityUnlockFailure": {
        capability: "hvutAbilityUnlock",
        stage: "abilityUnlockRequest",
      },
      "HVAA:lastHvutTrainingNotificationFailure": {
        capability: "hvutTrainingNotification",
        stage: "bottomTrainingHtmlEndTime",
      },
      "HVAA:lastHvutMoogleMailParseFailure": {
        capability: "hvutMoogleMailParse",
        stage: "viewCurrentCod",
      },
      "HVAA:lastHvutMoogleMailSendFailure": {
        capability: "hvutMoogleMailSend",
        stage: "attachRequest",
      },
      "HVAA:lastHvutMoogleMailActionFailure": {
        capability: "hvutMoogleMailAction",
        stage: "viewActionRequest",
      },
      "HVAA:lastHvutMonsterLabParseFailure": {
        capability: "hvutMonsterLabParse",
        stage: "upgradeChaosTokenCost",
      },
      "HVAA:lastHvutMonsterLabUpgradeFailure": {
        capability: "hvutMonsterLabUpgrade",
        stage: "upgradeUpdateRequest",
      },
      "HVAA:lastHvutPlayerStateParseFailure": {
        capability: "hvutPlayerStateParse",
        stage: "mainPlayerState",
      },
      "HVAA:lastHvutShrineCapacityFailure": {
        capability: "hvutShrineCapacity",
        stage: "shrineInventoryCapacity",
      },
      "HVAA:lastHvutShrineRewardParseFailure": {
        capability: "hvutShrineRewardParse",
        stage: "rewardSelectButton",
      },
      "HVAA:lastHvutShrineItemParseFailure": {
        capability: "hvutShrineItemParse",
        stage: "offerItemRow",
      },
      "HVAA:lastHvutShrineOfferFailure": { capability: "hvutShrineOffer", stage: "offerLoadFetch" },
      "HVAA:lastHvutRandomEncounterFailure": {
        capability: "hvutRandomEncounter",
        stage: "widgetNewsLoadFetch",
      },
      "HVAA:lastHvutPriceMarketParseFailure": {
        capability: "hvutPriceMarketParse",
        stage: "marketItemId",
      },
      "HVAA:lastHvutCharacterParseFailure": {
    ...
    expect(readRecentDiagnosticEvidence(window.sessionStorage)).toMatchObject({
      ...
      battleSessionFailure: { capability: "battleSession", stage: "write-checkpoint" },
      ...
      equipmentPercentileFailure: {
        capability: "equipmentPercentile",
        stage: "persist-preference",
      },
      equipmentFilterFailure: { capability: "equipmentFilter", stage: "match" },
      hvutRuntimeFailure: { capability: "hvutRuntime", stage: "executeHvUtils" },
      ...
      hvutAbilityParseFailure: { capability: "hvutAbilityParse", stage: "abilityButtonType" },
      hvutAbilityUnlockFailure: { capability: "hvutAbilityUnlock", stage: "abilityUnlockRequest" },
      hvutTrainingNotificationFailure: {
        capability: "hvutTrainingNotification",
        stage: "bottomTrainingHtmlEndTime",
      },
      hvutMoogleMailParseFailure: { capability: "hvutMoogleMailParse", stage: "viewCurrentCod" },
      hvutMoogleMailSendFailure: { capability: "hvutMoogleMailSend", stage: "attachRequest" },
      hvutMoogleMailActionFailure: {
        capability: "hvutMoogleMailAction",
        stage: "viewActionRequest",
      },
      hvutMonsterLabParseFailure: {
        capability: "hvutMonsterLabParse",
        stage: "upgradeChaosTokenCost",
      },
      hvutMonsterLabUpgradeFailure: {
        capability: "hvutMonsterLabUpgrade",
        stage: "upgradeUpdateRequest",
      },
      hvutPlayerStateParseFailure: { capability: "hvutPlayerStateParse", stage: "mainPlayerState" },
      hvutShrineCapacityFailure: {
        capability: "hvutShrineCapacity",
        stage: "shrineInventoryCapacity",
      },
      hvutShrineRewardParseFailure: {
        capability: "hvutShrineRewardParse",
        stage: "rewardSelectButton",
      },
      hvutShrineItemParseFailure: { capability: "hvutShrineItemParse", stage: "offerItemRow" },
      hvutRandomEncounterFailure: {
        capability: "hvutRandomEncounter",
        stage: "widgetNewsLoadFetch",
      },
      hvutPriceMarketParseFailure: { capability: "hvutPriceMarketParse", stage: "marketItemId" },
      hvutCharacterParseFailure: {
        capability: "hvutCharacterParse",
        stage: "personaEquipSetState",
      },
      hvutArmoryPageFailure: { capability: "hvutArmoryPage", stage: "scriptObjectParseFailed" },
      hvutArmorySubmitFailure: { capability: "hvutArmorySubmit", stage: "purchaseRequest" },
  ...
  it("can exclude a diagnostic source for self-recording evidence", () => {
    ...
    ).toEqual({ battleCompletion: { outcome: "victory" } });
  });
});
