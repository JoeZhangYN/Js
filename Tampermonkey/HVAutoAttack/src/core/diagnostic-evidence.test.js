...
describe("readRecentDiagnosticEvidence", () => {
  it("returns lifecycle, decision, and effect evidence together", () => {
    const evidenceByKey = {
      ...
      "HVAA:lastHvutI18nBridgeFailure": { capability: "hvutI18nBridge", stage: "retranslateEquiplistBridgeMissing" },
      ...
      "HVAA:lastHvutRuntimeFailure": { capability: "hvutRuntime", stage: "executeHvUtils", page: "https://hentaiverse.org/" }, "HVAA:lastHvutNavigationBridgeFailure": { capability: "hvutNavigationBridge", stage: "reloadBlocked" }, "HVAA:lastHvutHvaaConfigBridgeFailure": { capability: "hvutHvaaConfigBridge", stage: "topConfigIcon" }, "HVAA:lastHvutConfigStorageFailure": { capability: "hvutConfigStorage", stage: "set" }, "HVAA:lastHvutConfigParseFailure": { capability: "hvutConfigParse", stage: "configSeason" }, "HVAA:lastHvutItemShopParseFailure": { capability: "hvutItemShopParse", stage: "systemShopRow" }, "HVAA:lastHvutRepairLoadFailure": { capability: "hvutRepairLoad", stage: "battlePanelRepairLoadResponse" }, "HVAA:lastHvutTopLevelParseFailure": { capability: "hvutTopLevelParse", stage: "topLevelDetails" }, "HVAA:lastHvutAbilityParseFailure": { capability: "hvutAbilityParse", stage: "abilityButtonType" }, "HVAA:lastHvutAbilityUnlockFailure": { capability: "hvutAbilityUnlock", stage: "abilityUnlockRequest" }, "HVAA:lastHvutTrainingNotificationFailure": { capability: "hvutTrainingNotification", stage: "bottomTrainingHtmlEndTime" }, "HVAA:lastHvutMoogleMailParseFailure": { capability: "hvutMoogleMailParse", stage: "viewCurrentCod" }, "HVAA:lastHvutMoogleMailSendFailure": { capability: "hvutMoogleMailSend", stage: "attachRequest" }, "HVAA:lastHvutMoogleMailActionFailure": { capability: "hvutMoogleMailAction", stage: "viewActionRequest" }, "HVAA:lastHvutMonsterLabParseFailure": { capability: "hvutMonsterLabParse", stage: "upgradeChaosTokenCost" }, "HVAA:lastHvutMonsterLabUpgradeFailure": { capability: "hvutMonsterLabUpgrade", stage: "upgradeUpdateRequest" }, "HVAA:lastHvutPlayerStateParseFailure": { capability: "hvutPlayerStateParse", stage: "mainPlayerState" }, "HVAA:lastHvutShrineCapacityFailure": { capability: "hvutShrineCapacity", stage: "shrineInventoryCapacity" }, "HVAA:lastHvutShrineRewardParseFailure": { capability: "hvutShrineRewardParse", stage: "rewardSelectButton" }, "HVAA:lastHvutShrineItemParseFailure": { capability: "hvutShrineItemParse", stage: "offerItemRow" }, "HVAA:lastHvutShrineOfferFailure": { capability: "hvutShrineOffer", stage: "offerLoadFetch" }, "HVAA:lastHvutRandomEncounterFailure": { capability: "hvutRandomEncounter", stage: "widgetNewsLoadFetch" }, "HVAA:lastHvutPriceMarketParseFailure": { capability: "hvutPriceMarketParse", stage: "marketItemId" }, "HVAA:lastHvutCharacterParseFailure": { capability: "hvutCharacterParse", stage: "personaEquipSetState" }, "HVAA:lastHvutArmoryPageFailure": { capability: "hvutArmoryPage", stage: "scriptObjectParseFailed" }, "HVAA:lastHvutArmorySubmitFailure": { capability: "hvutArmorySubmit", stage: "purchaseRequest" }, "HVAA:lastHvutArmoryIntegrateFailure": { capability: "hvutArmoryIntegrate", stage: "integrateIncomplete" },
      "HVAA:lastAlarmNotificationFailure": { capability: "alarmNotification", stage: "gmNotification" }, "HVAA:lastLotteryNotificationFailure": { capability: "lotteryNotification", stage: "load" },
    };
    ...
    expect(readRecentDiagnosticEvidence(window.sessionStorage)).toMatchObject({
      ...
      hvutRuntimeFailure: { capability: "hvutRuntime", stage: "executeHvUtils" }, hvutNavigationBridgeFailure: { capability: "hvutNavigationBridge", stage: "reloadBlocked" }, hvutHvaaConfigBridgeFailure: { capability: "hvutHvaaConfigBridge", stage: "topConfigIcon" }, hvutConfigStorageFailure: { capability: "hvutConfigStorage", stage: "set" }, hvutTopLevelParseFailure: { capability: "hvutTopLevelParse", stage: "topLevelDetails" }, hvutRepairLoadFailure: { capability: "hvutRepairLoad", stage: "battlePanelRepairLoadResponse" }, hvutAbilityParseFailure: { capability: "hvutAbilityParse", stage: "abilityButtonType" }, hvutAbilityUnlockFailure: { capability: "hvutAbilityUnlock", stage: "abilityUnlockRequest" }, hvutTrainingNotificationFailure: { capability: "hvutTrainingNotification", stage: "bottomTrainingHtmlEndTime" }, hvutMoogleMailParseFailure: { capability: "hvutMoogleMailParse", stage: "viewCurrentCod" }, hvutMoogleMailSendFailure: { capability: "hvutMoogleMailSend", stage: "attachRequest" }, hvutMoogleMailActionFailure: { capability: "hvutMoogleMailAction", stage: "viewActionRequest" }, hvutMonsterLabParseFailure: { capability: "hvutMonsterLabParse", stage: "upgradeChaosTokenCost" }, hvutMonsterLabUpgradeFailure: { capability: "hvutMonsterLabUpgrade", stage: "upgradeUpdateRequest" }, hvutPlayerStateParseFailure: { capability: "hvutPlayerStateParse", stage: "mainPlayerState" }, hvutShrineCapacityFailure: { capability: "hvutShrineCapacity", stage: "shrineInventoryCapacity" }, hvutShrineRewardParseFailure: { capability: "hvutShrineRewardParse", stage: "rewardSelectButton" }, hvutShrineItemParseFailure: { capability: "hvutShrineItemParse", stage: "offerItemRow" }, hvutRandomEncounterFailure: { capability: "hvutRandomEncounter", stage: "widgetNewsLoadFetch" }, hvutPriceMarketParseFailure: { capability: "hvutPriceMarketParse", stage: "marketItemId" }, hvutCharacterParseFailure: { capability: "hvutCharacterParse", stage: "personaEquipSetState" }, hvutArmoryPageFailure: { capability: "hvutArmoryPage", stage: "scriptObjectParseFailed" }, hvutArmorySubmitFailure: { capability: "hvutArmorySubmit", stage: "purchaseRequest" }, hvutArmoryIntegrateFailure: { capability: "hvutArmoryIntegrate", stage: "integrateIncomplete" },
      alarmNotificationFailure: { capability: "alarmNotification", stage: "gmNotification" }, lotteryNotificationFailure: { capability: "lotteryNotification", stage: "load" },
    });
  });
