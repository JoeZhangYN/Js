...
describe("readRecentDiagnosticEvidence", () => {
  it("returns lifecycle, decision, and effect evidence together", () => {
    const evidenceByKey = {
      ...
      "HVAA:lastHvutNavigationBridgeFailure": { capability: "hvutNavigationBridge", stage: "reloadBlocked" }, "HVAA:lastHvutConfigStorageFailure": { capability: "hvutConfigStorage", stage: "set" }, "HVAA:lastHvutAbilityParseFailure": { capability: "hvutAbilityParse", stage: "abilityButtonType" }, "HVAA:lastHvutTrainingNotificationFailure": { capability: "hvutTrainingNotification", stage: "bottomTrainingHtmlEndTime" }, "HVAA:lastHvutMoogleMailParseFailure": { capability: "hvutMoogleMailParse", stage: "viewCurrentCod" }, "HVAA:lastHvutMonsterLabParseFailure": { capability: "hvutMonsterLabParse", stage: "upgradeChaosTokenCost" }, "HVAA:lastHvutPlayerStateParseFailure": { capability: "hvutPlayerStateParse", stage: "mainPlayerState" }, "HVAA:lastHvutShrineCapacityFailure": { capability: "hvutShrineCapacity", stage: "shrineInventoryCapacity" }, "HVAA:lastHvutPriceMarketParseFailure": { capability: "hvutPriceMarketParse", stage: "marketItemId" }, "HVAA:lastHvutCharacterParseFailure": { capability: "hvutCharacterParse", stage: "personaEquipSetState" },
    ...
    expect(readRecentDiagnosticEvidence(window.sessionStorage)).toMatchObject({
      ...
      hvutNavigationBridgeFailure: { capability: "hvutNavigationBridge", stage: "reloadBlocked" }, hvutConfigStorageFailure: { capability: "hvutConfigStorage", stage: "set" }, hvutAbilityParseFailure: { capability: "hvutAbilityParse", stage: "abilityButtonType" }, hvutTrainingNotificationFailure: { capability: "hvutTrainingNotification", stage: "bottomTrainingHtmlEndTime" }, hvutMoogleMailParseFailure: { capability: "hvutMoogleMailParse", stage: "viewCurrentCod" }, hvutMonsterLabParseFailure: { capability: "hvutMonsterLabParse", stage: "upgradeChaosTokenCost" }, hvutPlayerStateParseFailure: { capability: "hvutPlayerStateParse", stage: "mainPlayerState" }, hvutShrineCapacityFailure: { capability: "hvutShrineCapacity", stage: "shrineInventoryCapacity" }, hvutPriceMarketParseFailure: { capability: "hvutPriceMarketParse", stage: "marketItemId" }, hvutCharacterParseFailure: { capability: "hvutCharacterParse", stage: "personaEquipSetState" },
