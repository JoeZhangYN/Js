...
try {
  ...
  var create_hvut_ability_catalog = function (world, presentationCatalog, stage) {
    var bridge = typeof window !== 'undefined' ? window.HVAA_hvutAbilityCatalog : null;
    if (!bridge || typeof bridge.create !== 'function') {
      return record_hvut_ability_parse_failure(stage, { reason: 'abilityCatalogBridgeMissing', world: world });
    }
    var outcome = bridge.create({ world: world, presentationCatalog: presentationCatalog });
    if (!outcome || outcome.kind !== 'accepted') {
      return record_hvut_ability_parse_failure(stage, {
        reason: outcome?.reason || 'abilityCatalogCompositionRejected',
        world: world,
...
if (characterPage.isAbilities) {
  _ab.ability = create_hvut_ability_catalog('persistent', {
    ...
    'Mind Control': { category: 'Deprecating 1', img: '9.png', pos: -136 },
    'Better Silence': { category: 'Deprecating 2', img: 'c.png', pos: -170 },
    'Better MagNet': { category: 'Deprecating 2', img: 'u.png', pos: 0 },
    'Better Slow': { category: 'Deprecating 2', img: 'c.png', pos: 0 },
    'Better Drain': { category: 'Deprecating 2', img: '2.png', pos: 0 },
    'Faster Drain': { category: 'Deprecating 2', img: 'n.png', pos: 0 },
    'Ether Theft': { category: 'Deprecating 2', img: '2.png', pos: -34 },
