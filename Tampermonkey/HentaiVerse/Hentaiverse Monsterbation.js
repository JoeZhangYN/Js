...
const damage = document.getElementById('2501') ? 'Arcane Focus' : 'Heartseeker',
      ...
      regexp = { gem:/\w(\w+) Gem/, defaultgem:/\w(\w+).gem/, duration:/(x(\d))*[^(]*,\s?(\d+)/,
                ...
                zeroturn:/(You use|你使用了)\s*\w* (Gem|宝石|Draught|饮剂|Potion|药水|Elixir|秘药|Drink|饮料|Candy|糖果|Infusion|魔药|Scroll|卷轴|Vase|花瓶|Gum|泡泡糖)/, use:/You (cast|use) ([\w\s-]+)/,
                damage:/([^<>]+)(damage|伤害)( \([^<>]+\))*(<\/td><\/tr><tr><td class="tlb">Your spirit shield absorbs \d+ |<|\.)/g,
                ...
                spell:/(You cast|你咏唱了| hits |击中| crits |暴击| blasts |gains the effect|获得了状态)/, recovery:/(You are healed|Recovered | restores |You drain)/,
...
function Gems() {
    var ikeyp = document.getElementById('ikey_p');
    if (!ikeyp) {
        gem = [];
        return;
    }
    ...
    var raw = ikeyp.innerText || ikeyp.textContent || "";
    raw = raw.trim();
    // fallback 字体解析（仅当 innerText 为空或只有乱码）
    if (!raw || raw.length < 2) {
        try {
            raw = ParseDefault(ikeyp);
        } catch(e) {
            raw = "";
        }
    }
    raw = raw.toLowerCase();
    // 宝石关键字：中英混合全部支持
    var isMystic   = /mystic|神秘|神祕/.test(raw);
    var isHealth   = /health|生命|hp/.test(raw);
    var isMana     = /mana|魔力|mp/.test(raw);
    var isSpirit   = /spirit|靈力|灵力/.test(raw);
    // 依据匹配结果决定图标
    if (isMystic) {
        gem[2] = '/y/e/channeling.png';
    } else if (isHealth) {
        gem[2] = '/y/e/healthpot.png';
    } else if (isMana) {
        gem[2] = '/y/e/manapot.png';
        gem[3] = 0;
    } else if (isSpirit) {
        gem[2] = '/y/e/spiritpot.png';
        gem[3] = 1;
    } else {
        console.warn("未知宝石类型，原始文本:", raw);
        gem = [];
    }
}
        ...
        switch ( cfg.quickbarExtend[i] ) {
            ...
            default: if ( (spell = document.getElementById(cfg.quickbarExtend[i])) ) {
                ...
                if ( cfg.quickbarExtend[i].indexOf('ikey') < 0 ) {
                    ...
                    switch ( true ) {
                        case name.indexOf('ealth') > -1 || name.indexOf('生命') > -1: img.src = '/y/e/healthpot.png'; break;
                        case name.indexOf('ana') > -1 || name.indexOf('法力') > -1:
                            img.src = '/y/e/manapot.png';
                        ...
                        case name.indexOf('pirit') > -1 || name.indexOf('灵力') > -1: img.src = '/y/e/spiritpot.png';
                            if ( cfg.alertColours && name.indexOf('otion') > -1 && sp < (100-cfg.sppot+cfg.sppot*cfg.spboost/(cfg.spboost+100))/100 ) {
                                div.className += ' usable'; } break;
                        case name.indexOf('lixir') > -1 || name.indexOf('秘药') > -1: img.src = '/y/e/healthpot.png'; break;
                        case name.indexOf('rink') > -1 || name.indexOf('能量饮料') > -1: img.src = '/y/e/soulstone.png'; break;
                        case name.indexOf('andy') > -1 || name.indexOf('咖啡因糖果') > -1: img.src = '/y/e/soulstone.png'; break;
                        case name.indexOf('lames') > -1 || name.indexOf('火焰魔药') > -1: img.src = '/y/e/fireinfusion.png'; break;
                        case name.indexOf('rost') > -1 || name.indexOf('冰冷魔药') > -1: img.src = '/y/e/coldinfusion.png'; break;
                        case name.indexOf('ightning') > -1 || name.indexOf('闪电魔药') > -1: img.src = '/y/e/elecinfusion.png'; break;
                        case name.indexOf('torms') > -1 || name.indexOf('风暴魔药') > -1: img.src = '/y/e/windinfusion.png'; break;
                        case name.indexOf('ivinity') > -1 || name.indexOf('神圣魔药') > -1: img.src = '/y/e/holyinfusion.png'; break;
                        case name.indexOf('arkness') > -1 || name.indexOf('黑暗魔药') > -1: img.src = '/y/e/darkinfusion.png'; break;
                        case name.indexOf('wiftness') > -1 || name.indexOf('加速卷轴') > -1: img.src = '/y/e/haste_scroll.png'; break;
                        case name.indexOf('rotection') > -1 || name.indexOf('保护卷轴') > -1: img.src = '/y/e/protection_scroll.png'; break;
                        case name.indexOf('vatar') > -1 || name.indexOf('化身卷轴') > -1: img.src = '/y/e/protection_scroll.png'; break;
                        case name.indexOf('bsorption') > -1 || name.indexOf('吸收卷轴') > -1: img.src = '/y/e/absorb_scroll.png'; break;
                        case name.indexOf('hadows') > -1 || name.indexOf('幻影卷轴') > -1: img.src = '/y/e/shadowveil_scroll.png'; break;
                        case name.indexOf('ife') > -1 || name.indexOf('生命卷轴') > -1: img.src = '/y/e/sparklife_scroll.png'; break;
                        case name.indexOf('ods') > -1 || name.indexOf('神之卷轴') > -1: img.src = '/y/e/sparklife_scroll.png'; break;
                        case name.indexOf('ase') > -1 || name.indexOf('花瓶') > -1: img.src = '/y/e/flowers.png'; break;
                        case name.indexOf('um') > -1 || name.indexOf('泡泡糖') > -1: img.src = '/y/e/gum.png'; break;
